...
@property (nonatomic, strong) AppRankModel   *rank_show;                //  排行榜状态
...
@property (nonatomic, copy) NSString        *app_name;              // app名称  小龙女直播
...
@property (nonatomic, assign) int           open_vip_pop;      // 是否开启直播间内发言提示购买vip 1:开启;0:不开启
@property (nonatomic, assign) int           open_verification;      // 是否开启IM验签 1:开启;0:不开启
@property (nonatomic, assign) int           open_driver;            // 是否开启座驾功能 1:开启;0:不开启
...
@property (nonatomic, copy) NSString     *live_chat_url;            // 客服聊天链接
@property (nonatomic, copy) NSString     *room_ad_a_name;            // 直播间广告1内容
@property (nonatomic, copy) NSString     *room_ad_a_url;            // 直播间广告1链接
@property (nonatomic, copy) NSString     *room_ad_b_name;            // 直播间广告2内容
@property (nonatomic, copy) NSString     *room_ad_b_url;            // 直播间广告2链接
@property (nonatomic, copy) NSString     *limit_name;            // 脏字
@property (nonatomic, strong) NSArray *home_adtab_list;              // 首页tab广告
