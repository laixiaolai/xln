...
- (void)initFWUI
{
    ...
    {  // 显示返回、关闭按钮
        UIBarButtonItem *buttonItem1 = [UIBarButtonItem itemWithTarget:self action:@selector(webViewReturnBtnPress) image:@"com_arrow_vc_back_b" highImage:@"com_arrow_vc_back_b"];
