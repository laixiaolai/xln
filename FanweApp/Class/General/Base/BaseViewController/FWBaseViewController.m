...
- (void)setupBackBtnWithBlock:(BackBlock)backBlock
{
    ...
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem itemWithTarget:self action:@selector(onReturnBtnPress) image:@"com_arrow_vc_back_b" highImage:@"com_arrow_vc_back_b"];
}
