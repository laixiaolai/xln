...
@property(nonatomic,copy)NSString* driver_code;//坐骑编码
@property(nonatomic,copy)NSString* driver_name;//坐骑名称
@property (copy, nonatomic) NSString * is_vip;//会员是否过期 @"1"未过期
...
-(void)storageOpenDriver:(int)IsOpen;
