...
+ (GlobalVariables *)sharedInstance
{
    ...
    dispatch_once(&predicate, ^{
        ...
        NSString *isVip = [[NSUserDefaults standardUserDefaults] objectForKey:kIsVip];
        myInstance.is_vip = isVip;
        
        NSString *driverCode = [[NSUserDefaults standardUserDefaults] objectForKey:kDriverCode];
        myInstance.driver_code = driverCode;
        
        NSString *driverName = [[NSUserDefaults standardUserDefaults] objectForKey:kDriverName];
        myInstance.driver_name = driverName;
        
        NSString *nickName = [[NSUserDefaults standardUserDefaults] objectForKey:kNickName];
        myInstance.nick_name = nickName;
        
        NSString *headImage = [[NSUserDefaults standardUserDefaults] objectForKey:kHeadImage];
        myInstance.head_image = headImage;
    });
    return myInstance;
}
...
-(void)storageIsVip:(NSString *)isVip{
    self.is_vip = isVip;
    [[NSUserDefaults standardUserDefaults] setObject:isVip forKey:kIsVip];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
-(void)storageDriverCode:(NSString*)code{
    self.driver_code = code;
    [[NSUserDefaults standardUserDefaults] setObject:code forKey:kDriverCode];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
-(void)storageDriverName:(NSString*)name{
    self.driver_name = name;
    [[NSUserDefaults standardUserDefaults] setObject:name forKey:kDriverName];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
-(void)storageNick_name:(NSString *)name{
    self.nick_name = name;
    [[NSUserDefaults standardUserDefaults] setObject:name forKey:kNickName];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
-(void)storageHead_image:(NSString *)image{
