...
/**
 ...
 @param urlStr 接口基本地址
 @param paramDict1 请求参数
 @param PostSuccess 成功回调
 @param PostFailure 失败回调
 */
- (void)POSTWithUrl:(NSString *)urlStr paramDict:(NSMutableDictionary *)paramDict1 SuccessBlock:(SuccessBlock)PostSuccess FailureBlock:(FailureBlock)PostFailure
{
    NSMutableDictionary *paramDict=[[NSMutableDictionary alloc] init];
    paramDict = [NetWorkManager getLocalParm:paramDict1 url:urlStr];
