...
@interface JiaziguViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation JiaziguViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"jiazigu" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(jiaziguAnimationFinished)]) {
            [_delegate jiaziguAnimationFinished];
        }
