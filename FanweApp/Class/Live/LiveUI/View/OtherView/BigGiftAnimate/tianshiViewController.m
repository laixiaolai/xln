...
@interface TianshiViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation TianshiViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"tianshi" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(tianshiAnimationFinished)]) {
            [_delegate tianshiAnimationFinished];
        }
