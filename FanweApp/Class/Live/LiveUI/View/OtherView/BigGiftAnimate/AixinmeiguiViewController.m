...
@interface AixinmeiguiViewController ()<SVGAPlayerDelegate>

@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation AixinmeiguiViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"aixinmeigui" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(aixinmeiguiAnimationFinished)]) {
            [_delegate aixinmeiguiAnimationFinished];
        }
