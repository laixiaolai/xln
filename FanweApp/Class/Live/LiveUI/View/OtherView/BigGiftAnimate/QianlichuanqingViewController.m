//
//  QianlichuanqingViewController.m
//  FanweApp
//
...
@interface QianlichuanqingViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation QianlichuanqingViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"qianlichuanqing" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(qianlichuanqingAnimationFinished)]) {
            [_delegate qianlichuanqingAnimationFinished];
        }
