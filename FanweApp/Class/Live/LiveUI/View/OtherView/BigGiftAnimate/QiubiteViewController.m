...
@interface QiubiteViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation QiubiteViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"qiubite" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(qiubiteAnimationFinished)]) {
            [_delegate qiubiteAnimationFinished];
        }
