//
//  FeixuexiaozhenViewController.m
//  FanweApp
//
...
@interface FeixuexiaozhenViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation FeixuexiaozhenViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"feixuexiaozhen" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(feixuexiaozhenAnimationFinished)]) {
            [_delegate feixuexiaozhenAnimationFinished];
        }
