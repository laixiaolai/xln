...
@interface KongmingViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation KongmingViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"kongming" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(kongmingAnimationFinished)]) {
            [_delegate kongmingAnimationFinished];
        }
