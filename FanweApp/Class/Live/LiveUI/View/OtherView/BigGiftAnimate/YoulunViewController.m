...
@interface YoulunViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation YoulunViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"youlun" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(youlunAnimationFinished)]) {
            [_delegate youlunAnimationFinished];
        }
