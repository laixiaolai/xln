...
@interface JitaViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation JitaViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"jita" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(jitaAnimationFinished)]) {
            [_delegate jitaAnimationFinished];
        }
