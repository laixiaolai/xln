...
@interface ZuanjieViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation ZuanjieViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"zuanjie" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(zuanjieAnimationFinished)]) {
            [_delegate zuanjieAnimationFinished];
        }
