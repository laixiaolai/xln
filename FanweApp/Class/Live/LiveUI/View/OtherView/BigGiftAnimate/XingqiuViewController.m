...
@interface XingqiuViewController ()<SVGAPlayerDelegate>
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"xingqiu" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(xingqiuAnimationFinished)]) {
            [_delegate xingqiuAnimationFinished];
        }
