...
@interface HuojianViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation HuojianViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"huojian" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(huojianAnimationFinished)]) {
            [_delegate huojianAnimationFinished];
        }
