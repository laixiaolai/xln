...
@interface YingmuhuadaoViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation YingmuhuadaoViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"yingmuhuadao" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(yingmuhuadaoAnimationFinished)]) {
            [_delegate yingmuhuadaoAnimationFinished];
        }
