...
@interface ZhishengjiViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation ZhishengjiViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"zhishengji" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(zhishengjiAnimationFinished)]) {
            [_delegate zhishengjiAnimationFinished];
        }
