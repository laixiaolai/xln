...
@interface ZhushishunliViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation ZhushishunliViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"zhushishunli" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(zhushishunliAnimationFinished)]) {
            [_delegate zhushishunliAnimationFinished];
        }
