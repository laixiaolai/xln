...
@interface HuangguanViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation HuangguanViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"huangguan" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(huangguanAnimationFinished)]) {
            [_delegate huangguanAnimationFinished];
        }
