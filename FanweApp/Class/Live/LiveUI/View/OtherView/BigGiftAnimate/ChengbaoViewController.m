...
@interface ChengbaoViewController ()
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation ChengbaoViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"chengbao" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(chengbaoAnimationFinished)]) {
            [_delegate chengbaoAnimationFinished];
        }
