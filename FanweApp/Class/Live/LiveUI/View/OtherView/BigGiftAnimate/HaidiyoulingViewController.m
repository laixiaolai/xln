...
@interface HaidiyoulingViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation HaidiyoulingViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"haidiyouling" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(haidiyoulingAnimationFinished)]) {
            [_delegate haidiyoulingAnimationFinished];
        }
