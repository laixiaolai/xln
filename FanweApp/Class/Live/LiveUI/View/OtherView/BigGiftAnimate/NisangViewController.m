...
@interface NisangViewController ()<SVGAPlayerDelegate>
@property (nonatomic, strong) SVGAPlayer *aPlayer;
@end

@implementation NisangViewController{
...
- (void)viewDidLoad {
    ...
    [parser parseWithNamed:@"nisang" inBundle:nil
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    if ([value isEqualToString:@"moveAnimation"]){
        ...
        if (_delegate && [_delegate respondsToSelector:@selector(nisangAnimationFinished)]) {
            [_delegate nisangAnimationFinished];
        }
