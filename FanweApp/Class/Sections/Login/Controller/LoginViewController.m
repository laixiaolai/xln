...
- (void)creatView
{
    ...
    loginLabel.textColor = kAppMainColor;
    loginLabel.textAlignment = NSTextAlignmentCenter;
    [self.view addSubview:loginLabel];
    
    UIView *lefeView = [[UIView alloc]initWithFrame:CGRectMake(kScreenW*0.35-45, kScreenH*0.6+14, kScreenW*0.15, 2)];
    lefeView.backgroundColor = kAppMainColor;
    [self.view addSubview:lefeView];
    
    UIView *rightView = [[UIView alloc]initWithFrame:CGRectMake(kScreenW*0.5+45, kScreenH*0.6+14, kScreenW*0.15, 2)];
    rightView.backgroundColor = kAppMainColor;
    ...
    [registButton setTitleColor:kAppMainColor forState:UIControlStateNormal];
    ...
    if ([GlobalVariables sharedInstance].appModel.has_visitors_login)
    {
        ...
        [self.visitorsLoginBtn setTitleColor:kAppMainColor forState:UIControlStateNormal];
        ...
        //此时如果设置字体颜色要这样
        [tncString addAttribute:NSForegroundColorAttributeName value:kAppMainColor  range:NSMakeRange(0,[tncString length])];
        
        //设置下划线颜色...
        [tncString addAttribute:NSUnderlineColorAttributeName value:kAppMainColor range:(NSRange){0,[tncString length]}];
