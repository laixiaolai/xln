...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.locationBtn =  [self setButtomNormalImage:@"pl_publishlive_nolocation" selectedImage:@"pl_publishlive_location" text:@"开定位" normalcolor:kAppGrayColor4 selectedColor:kBlackColor  frame:CGRectMake(10, 36, 65, 15) sel:@selector(locationBtnAction:)];
        ...
        self.pravicyBtn = [self setButtomNormalImage:@"pl_publishlive_pravicyoff" selectedImage:@"pl_publishlive_pravicyon" text:@"私密" normalcolor:kAppGrayColor2 selectedColor:kBlackColor frame:CGRectMake(80, 36, 60, 15) sel:@selector(pravicyBtnAction:)];
        self.classifyBtn = [self setButtomNormalImage:@"pl_publishlive_classify" selectedImage:@"pl_publishlive_classify" text:@"选择分类" normalcolor:kAppGrayColor1 selectedColor:kBlackColor frame:CGRectMake(150, 36, 80, 15) sel:@selector(classifyBtnAction:)];
        self.closeBtn = [self setButtomNormalImage:@"pl_publishlive_close" selectedImage:@"pl_publishlive_close" text:@"" normalcolor:kAppGrayColor3 selectedColor:kBlackColor frame:CGRectMake(self.width - 35, 36, 20, 20) sel:@selector(closeBtnAction:)];
    }
    return self;
}
