...
@property ( nonatomic,strong)UIImageView       *LVipImgView;          //是否vip
...
@property ( nonatomic,strong)UIImageView       *MVipImgView;          //是否vip
...
@property ( nonatomic,strong)UIImageView       *RVipImgView;          //是否vip
