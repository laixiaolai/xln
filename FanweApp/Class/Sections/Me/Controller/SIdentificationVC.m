...
- (void)initFWUI
{
    ...
    self.navigationItem.leftBarButtonItem=[UIBarButtonItem itemWithTarget:self action:@selector(backClick) image:@"com_arrow_vc_back_b" highImage:@"com_arrow_vc_back_b"];
    ...
    self.idAuthenView   = [self creatViewWithStr:@""];
