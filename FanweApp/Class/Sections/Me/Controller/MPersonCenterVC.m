    ...
    [self.httpsManager POSTWithParameters:parmDict SuccessBlock:^(NSDictionary *responseJson)
     {
         ...
         if ([responseJson toInt:@"status"] == 1)
         {
             ...
             [[GlobalVariables sharedInstance] storageIsVip:_userModel.is_vip];
             [[GlobalVariables sharedInstance] storageNick_name:_userModel.nick_name];
             [[GlobalVariables sharedInstance] storageHead_image:_userModel.head_image];
         }else
         {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cell.rightLabel.textColor  = kAppMainColor;
    }
