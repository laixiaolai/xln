...
{
    self.payWayLabel.backgroundColor = model.isSelect == YES ? kWhiteColor : kWhiteColor;
    self.payWayLabel.textColor = model.isSelect == YES ? kAppMainColor :kAppGrayColor1;
...
- (void)layoutSubviews
{
    ...
    self.payWayLabel.layer.borderColor = kWhiteColor.CGColor;
}
