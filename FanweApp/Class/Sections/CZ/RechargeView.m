...
- (instancetype)initWithFrame:(CGRect)frame andUIViewController:(UIViewController *)viewController
{
    if (self = [super initWithFrame:frame])
    {
        ...
        UIImage *bgImage = [UIImage imageNamed:@"lr_recharge_bg"];
        ...
        [_rechargeBtn setTitleColor:kWhiteColor forState:UIControlStateNormal];
        ...
        _balanceLabel.textColor = kAppMainColor;
